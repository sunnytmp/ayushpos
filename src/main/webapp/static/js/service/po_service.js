...
App.factory('POService', ['$http', '$q',  '$location','$window', function($http, $q, $location, $window){
    ...
    return {
    			...
    			createPOS: function() {
    			            ...
    			            return $http.get('http://ec2-52-25-144-174.us-west-2.compute.amazonaws.com:8080/restpos/sup/')
    	                            .then(
    							            function(response){
    	...
    	fetchAllPOS: function() {
            ...
            sendPoId: function( path) {
             
            	console.log($window.location.host);
            	 $window.location.href =  "/viewpos/Item";
            	
            },
            
            createPO: function(po){
                    return $http.post('http://ec2-52-25-144-174.us-west-2.compute.amazonaws.com:8080/restpos/PurchaseOrder/', po)
                            .then(
                                    function(response){
                                        return response.data;
                                    }, 
