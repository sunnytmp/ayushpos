                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
 					...
 					<div class="row">
                          ...
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.accountid" name="accountid" class="accountid form-control input-sm" placeholder="Acccount Id Generated" required ng-minlength="9"/>
